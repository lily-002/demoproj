...
class StoreProducerReceiptRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'product_category'=> ['sometimes','exists:product_categories,id'],
            'product_subcategory'=>['sometimes','exists:product_subcategories,id'],
